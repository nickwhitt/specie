<template>
  <article>
    ...
    <ProseH2 id="flowing-hair">Flowing Hair Cent</ProseH2>
    ...
    <TypeDetail title="Liberty Cap Cent" slug="liberty-cap" :images="[
      '/cents/liberty-cap-obv.webp',
    ]">
      <ProseP>
      </ProseP>
    </TypeDetail>

    <TypeDetail title="Draped Bust Cent" slug="draped-bust" :images="[
      '/cents/draped-bust-obv.webp',
    ]">
      <ProseP>
      </ProseP>
    </TypeDetail>

    <TypeDetail title="Classic Head Cent" slug="classic-head" :images="[
      '/cents/classic-head-obv.webp',
    ]">
      <ProseP>
      </ProseP>
    </TypeDetail>

    <ProseH2 id="liberty-head">Liberty Head Cent</ProseH2>
    ...
    <TypeDetail :images="[
      ...
      <template #title>
        <ProseH3 id="matron-head">Matron or Coronet Head</ProseH3>
      </template>
      <ProseP>
    ...
    <TypeDetail :images="[
      ...
      <template #title>
        <ProseH3 id="braided-hair">Braided Hair</ProseH3>
      </template>
      <ProseP>
    ...
    <TypeDetail title="Flying Eagle Cent" slug="flying-eagle" :images="[
      '/cents/flying-eagle-obv.webp',
    ]">
      <ProseP>
      </ProseP>
    </TypeDetail>

    <TypeDetail title="Indian Head Cent" slug="indian-head" :images="[
      '/cents/indian-head-obv.webp',
    ]">
      <ProseP>
      </ProseP>
    </TypeDetail>

    <ProseH2 id="lincoln">Lincoln Cent</ProseH2>
    ...
    <TypeDetail :images="[
      ...
      <template #title>
        <ProseH3 id="wheat-ears">Wheat Ears Reverse</ProseH3>
      </template>
      <ProseP>
    ...
    <TypeDetail :images="[
      ...
      <template #title>
        <ProseH3 id="memorial">Memorial Reverse</ProseH3>
      </template>
      <ProseP>
      ...
      <UButtonGroup class="-ms-2.5">
        ...
        <TypeIssues title="Lincoln, Memorial Cent Issues" description="Circulation Strikes" :issues="memorialIssues" />
    ...
    <TypeDetail :images="[
      ...
      <template #title>
        <ProseH3 id="bicentennial">Bicentennial Reverses</ProseH3>
      </template>
      <ProseP>
    ...
    <TypeDetail :images="[
      ...
      <template #title>
        <ProseH3 id="shield">Shield Reverse</ProseH3>
      </template>
      <ProseP>
